...
##### Parameters
windowSize=$3;      # The size of the DIST prediction window (Mb).
wingSize=$4;        # The size of the area (wing) flanking the left and right of the DISTMIX prediction window (Mb).

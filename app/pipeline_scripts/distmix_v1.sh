...
##### Directories
#production
bin_dir="/local/datasets/distmix";
db_dir="/local/datasets/distmix"

#development
#bin_dir="/local/datasets/impute";
#db_dir="/local/datasets/impute"
...
Rscript --vanilla ${bin_dir}/plot_frequency.R ${output_dir}/imputation.txt ${output_dir}
